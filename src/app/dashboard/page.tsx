...
import { LocateFixed, Navigation, Mic, MicOff, LogOut } from 'lucide-react';
  ...
  return (
    <div className="relative h-screen w-screen bg-background overflow-hidden">
      ...
      <div className="absolute top-4 left-4 right-4 flex items-start justify-between z-10">
        <h1 className="text-4xl font-bold text-primary drop-shadow-lg font-headline">Navify</h1>
        <div className="flex items-center gap-2">
          ...
          {isNavigating && (
           ...
           <Button size="icon" variant="secondary" className="rounded-full shadow-lg" onClick={() => router.push('/')}>
